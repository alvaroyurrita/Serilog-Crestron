...
{
    /// <summary> Class that Enriches the log with a Crestron Program ID Tag for Crestron Control Appliances or Room Name for Crestron Control Servers. </summary>
    public class ProgramNameEnricher : CachedPropertyEnricher
    {
        ...
        {
            var roomName = InitialParametersClass.RoomName == "" ? InitialParametersClass.ProgramIDTag : InitialParametersClass.RoomName;
