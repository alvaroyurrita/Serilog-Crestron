...
namespace Serilog.Crestron.Enrichers
{
    ...
    {
        /// <summary>
        ///     Enrich log events with a SlotNo property containing the value of the Running Program Slot No on Crestron Control
        ///     Appliances, or the Room ID on Crestron Control Servers.
        /// </summary>
        ...
        /// <summary>
        ///     Enrich log events with a ProgramName containing the value of the Crestron Program ID Tag on Crestron Control
        ///     Appliances, or Room Name on Crestron Control Servers.
        /// </summary>
        /// <param name="enrichmentConfiguration">Logger enrichment configuration.</param>
        /// <returns>Configuration object allowing method chaining.</returns>
