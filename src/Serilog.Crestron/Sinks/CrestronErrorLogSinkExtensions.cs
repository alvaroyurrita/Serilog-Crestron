...
namespace Serilog.Crestron.Sinks
{
    ...
    public static class CrestronErrorLogLoggerConfigurationExtensions
    {
        ...
        /// <param name="formatProvider">Controls the rendering of log events into text, for example to log JSON. To
        ...
        /// The default is <code>"[{Level:u3}] {Message:lj}"</code>.</param>
            ...
            object? syncRoot = null)
        {
            ...
            return sinkConfiguration.Sink(new CrestronErrorLogSink(formatter, syncRoot), restrictedToMinimumLevel, levelSwitch);
        }
    }
}
