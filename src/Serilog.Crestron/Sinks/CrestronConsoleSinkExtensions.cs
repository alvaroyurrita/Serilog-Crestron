...
namespace Serilog.Crestron.Sinks
{
    ...
    {
        private const string DEFAULT_CONSOLE_OUTPUT_TEMPLATE =
        ...
        ///     uses <see cref="ConsoleTheme.None" />.
        /// </param>
            ...
            object? syncRoot = null)
        {
            ...
            return sinkConfiguration.Sink(new CrestronConsoleSink(appliedTheme, formatter, syncRoot),
            ...
            object? syncRoot = null)
        {
            if (sinkConfiguration is null) throw new ArgumentNullException(nameof(sinkConfiguration));
            syncRoot ??= DefaultSyncRoot;
            return sinkConfiguration.Sink(new CrestronConsoleSink(ConsoleTheme.None, formatter, syncRoot),
                restrictedToMinimumLevel, levelSwitch);
        }
    }
}