...
namespace Serilog.Crestron.Sinks.CrestronConsole.Platform
{
    ...
    public class CrestronConsoleTextWriter : TextWriter
    {
        ...
        /// <summary>
        /// Crestron Console is capable of displaying characters above 127. Encoding is set to ISO-8859-1 so they don't get confused with unicode.
        /// </summary>
        ...
        public override void Write(char value) => global::Crestron.SimplSharp.CrestronConsole.Print(FormatProvider != null ? value.ToString(FormatProvider) : value.ToString());
        /// <summary>
        /// Writes to Crestron Console
        /// </summary>
        /// <param name="value">Value To write</param>
        ...
        /// </summary>
        public override void WriteLine() => global::Crestron.SimplSharp.CrestronConsole.Print("\r\n");
        /// <summary>
